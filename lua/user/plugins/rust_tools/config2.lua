...
local codelldb_path = codelldb_cmdhandle:read "*all" --  .. ' --params {"showDisassembly" : "never"}'
local liblldb_cmdhandle =
  io.popen 'find -L $HOME/.local/share/nvim/mason/packages/codelldb/extension/lldb/lib/ -name "liblldb.so" -type f -print0'
---@diagnostic disable-next-line: need-check-nil
local liblldb_path = liblldb_cmdhandle:read "*all"
